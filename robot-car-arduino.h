...
class Ultrasonido {
	...
	//Constructor prarametrizado Recibe como parametros Trigger y Echo como byte
...
class Carro{
	...
	byte potenciaI=6;	//pin de potencia llanta Izquierda pin PWN
	byte adelanteD=7;	//Adelante llanta Derecha
	byte atrasD=8;		//atras llanta Derecha
	byte potenciaD=9;	//potencia llanta Derecha pin PWN
	...
	//Gira la cantidad de grados especifica: - a la izquierda, + derecha
	//usa los contadores de vuelta para la precision al girar
	//tu decides si usas dos llanta para girar o solo una
